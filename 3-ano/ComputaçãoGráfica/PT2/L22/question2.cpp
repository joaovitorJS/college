...
//*** Uncomment the part from clown2.cpp and then clown3.cpp for those programs. ***
void drawScene(void)
{
    ...
    glPushMatrix();
        ...
        glScalef(1.0, 1.0, 1.0 + sin((PI / 180.0) * angle));

        glColor3f(6.0, 0.0, 6.0);
        glutWireCone(0.3, 1.0, 10, 10);
    glPopMatrix();
    ...
    glPushMatrix();
        ...
        glScalef(2.0 + sin((PI / 180.0) * angle), 2.0 + sin((PI / 180.0) * angle), 1.0);

        glColor3f(1.0, 0.0, 0.0);
        glutWireTorus(0.1, 0.1, 10, 15);
    glPopMatrix();
